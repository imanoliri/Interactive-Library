...
<body>
    ...
    <div id="fullscreenImgModal">
        ...
        <button id="fightEnemyBtn" class="game-fight-btn" style="display:none;" onclick="showGameUI()">⚔️ Fight Enemy!</button>
            ...
            <div class="game-ui-panel">
                ...
                <div class="player-actions">
                    ...
                    <div class="strength-btn-grid" id="strengthSelector">
                        ...
                        <button class="strength-btn" onclick="selectStrength('Heavy', this)">💣 Heavy (3pts)</button>
                    </div>
                </div>
